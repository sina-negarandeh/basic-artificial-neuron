...
LAB20:    t79 = (t0 + 4096);
    ...
    *((unsigned int *)t89) = (t91 | t85);
    xsi_driver_vfirst_trans(t79, 0, 15);
    t92 = (t0 + 3984);
    *((int *)t92) = 1;
...
LAB12:    t53 = (t0 + 1688U);
    ...
    *((unsigned int *)t53) = (t61 & 32767U);
    t62 = ((char*)((ng1)));
    xsi_vlogtype_concat(t51, 16, 16, 2U, t62, 1, t52, 15);
    goto LAB13;
...
LAB14:    t69 = (t0 + 1688U);
    ...
    *((unsigned int *)t69) = (t77 & 32767U);
    t78 = ((char*)((ng2)));
    xsi_vlogtype_concat(t67, 16, 16, 2U, t78, 1, t68, 15);
    goto LAB15;

LAB16:    xsi_vlog_unsigned_bit_combine(t3, 16, t51, 16, t67, 16);
    goto LAB20;
...
extern void work_m_00000000000303772402_3367809584_init()
{
	static char *pe[] = {(void *)Cont_112_0,(void *)implSig1_execute,(void *)implSig2_execute};
	xsi_register_didat("work_m_00000000000303772402_3367809584", "isim/test_bench_isim_beh.exe.sim/work/m_00000000000303772402_3367809584.didat");
